      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            title="Cargar ejemplo con formato estructurado ChatGPT + Prompts"
          >
      ...
      <div className="p-3 rounded-xl bg-slate-900/60 border border-slate-800/80 text-[11px] text-slate-400 space-y-2">
        ...
        {showFormatGuide ? (
          <div className="space-y-1.5 pt-1 text-[10px] border-t border-slate-800/80 font-mono text-slate-400">
            <p className="text-purple-300 font-bold">Campos estructurados reconocidos:</p>
            ...
            <p><span className="text-blue-300">VISUAL:</span> Concepto del fondo</p>
          ...
          <p className="text-[10px] text-slate-400">
            Acepta formato rápido con barra vertical (<code className="text-blue-300 font-mono">Título | Cuerpo</code>) y formato estructurado <code className="text-purple-300 font-mono">ChatGPT (TYPE, PROMPT, etc.)</code>.
          </p>
        )}
      </div>
    </div>
